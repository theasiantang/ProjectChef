        ...
        if(mDialog != null){
            ...
            PositiveButton.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    ...
                    String InstructionsText = getArguments().getString("InstructionData");
                    ...
                    if(Description.matches("")){    // Checks if description has been filled
                        ...
                        AddRecipeFragment.InstructionsText.setText(Description);
                        ...
                        AddRecipeFragment.InstructionsText.setText(InstructionsText + "\n" + Description);
                        Toast.makeText(getActivity(), "Step Added", Toast.LENGTH_SHORT).show();
                        dismiss(); // closes dialog box
                    }
                }
